...
#};
use SVG;
my %opt = (flank_x=>40,flank_y=>20,flank_b=>140,height=>300,flank_y=>20,lw=>1.5,fsize=>15,type=>0,barlen=>400,
...
my @bcolor = $opt{bcolor} ? split/,/,$opt{bcolor} :
    qw(red limegreen yellow mediumblue darkorchid fuchsia darkgoldenrod dimgray lawngreen darkblue 
    deeppink sandybrown deepskyblue lightgreen lightcorol salmon tan silver tomato indigo violet gold lightseagreen);
if(-s $rgb_txt){
